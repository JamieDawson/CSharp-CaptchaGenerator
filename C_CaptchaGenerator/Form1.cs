...
#region How to use this program
//Create a folder on your desktop labled "Output"
//Run this program
//click the "choose folder" button and select the "Output" folder.
//Type a number into the textbox. 
//Hit the "Start" button. This will load the images into the folder.
//click "Open to view images" and select the "Output" folder.
//Select the image you want.
//Type out the code in the textbox.
//hit "Submit".
//If you typed it correctly, then it should say "You got it right"! 
#endregion

namespace C_CaptchaGenerator
{
    public partial class Form1 : Form
    {
        ...
        Image[] GenerateCaptchas(int amount)
        {
            ...
            for (int z = 0; z < amount; z++)
            {
                ...
                char[] chars = "qwertyuiopasdfghjklzxcvbnm123456789".ToCharArray();
                string randomString = "";
                for (int i = 0; i < 6; i++)
                {
